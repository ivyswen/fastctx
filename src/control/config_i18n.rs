...
const EN: ConfigMessages = config_messages!(
    ...
    "CPU limit",
    "Automatic",
    "Used by grep/glob; applies after the shared control center restarts. Apply is not required.",
    "Edit CPU limit",
...
const ZH_CN: ConfigMessages = config_messages!(
    ...
    "CPU 限制",
    "自动",
    "用于 grep/glob；共享控制中心重启后生效。无需 Apply。",
    "编辑 CPU 限制",
    "输入 auto 或 1..={maximum}：",
    "值不能为空。",
    "请输入 auto 或整数。",
...
const ZH_TW: ConfigMessages = config_messages!(
    ...
    "CPU 限制",
    "自動",
    "用於 grep/glob；共享控制中心重新啟動後生效。不需要 Apply。",
    "編輯 CPU 限制",
    "輸入 auto 或 1..={maximum}：",
    "值不可為空。",
    "請輸入 auto 或整數。",
