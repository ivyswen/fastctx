...
const EN: ConfigMessages = config_messages!(
    ...
    "CPU limit",
    "Automatic",
    "Used by grep/glob; takes effect once every Codex session has closed and the shared control center exits. Reconnecting is not required.",
    "Edit CPU limit",
    "Enter 1..={maximum}:",
...
const ZH_CN: ConfigMessages = config_messages!(
    ...
    "CPU 限制",
    "自动",
    "用于 grep/glob；所有 Codex 会话关闭、共享控制中心退出后生效。无需重新接入。",
    "编辑 CPU 限制",
    "输入 1..={maximum}：",
    "值不能为空。",
    "请输入整数。",
...
const ZH_TW: ConfigMessages = config_messages!(
    ...
    "CPU 限制",
    "自動",
    "用於 grep/glob；所有 Codex 工作階段關閉、共享控制中心結束後生效。不需要重新接入。",
    "編輯 CPU 限制",
    "輸入 1..={maximum}：",
    "值不可為空。",
    "請輸入整數。",
